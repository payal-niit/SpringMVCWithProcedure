          ...
          <fieldset>
            ...
            <div class="form-group">              
              ...
              <div class="controls col-sm-8">
                <form:input id="emailId" path="cust_eml_addrss" name="cust_eml_addrss" placeholder="Email Address" cssClass="form-control" required="true" title="Enter a valid Email Address"/>
              </div>
            ...
            <div class="form-group">
              ...
              <div class="controls col-sm-8">
                <form:input type="date" path="cust_dob" id="dob"  name="cust_dob" cssClass="form-control" required="true" placeholder="Date of Birth"/>
              </div>
            </div>
